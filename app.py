...
@app_bp.route('/carts', methods=['POST'])
def create_cart():
...
@app_bp.route('/carts', methods=['GET'])
def get_all_carts():
...
@app_bp.route('/transactions', methods=['POST'])
...
@app_bp.route('/addresses', methods=['POST'])
def create_address():
    user_id = request.json.get('user_id')
...
@app_bp.route('/addresses', methods=['GET'])
...
@app_bp.route('/order_items', methods=['POST'])
...
@app_bp.route('/order_items', methods=['GET'])
